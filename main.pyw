...
FEED_INTERVAL = datetime.timedelta(hours=user_config["refresh_interval_hours"])
...
class SystemTrayApp(QObject):
    ...
    def setup_tray(self):
        ...
        # The tooltip shows the last time that the feed was updated
        self.tray_icon.setToolTip(self.feed_time.strftime("Last updated: %Y-%m-%d %H:%M:%S"))
